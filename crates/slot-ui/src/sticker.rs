...
pub const CREDITS: [&str; 10] = [
    "EMULATION IS LIBRETRO CORES,",
    "MGBA AND GPSP. AGS-102 IS A",
    "FORK OF BASEOS BY PVAIBHAV.",
    "TYPE IS OPEN SANS AND NERD",
    "FONTS, SYMBOLS BY RYAN L",
    "MCINTYRE. THE MASK IS FROM",
    "GIGAHERZ'S LCD3X. THE CART",
